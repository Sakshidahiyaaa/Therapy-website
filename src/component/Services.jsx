    ...
    <>
      <section className="services-wrapper">
        <div className="services-intro">
          <h2>Therapy can be a space where you invest in yourself—<br />one of the highest forms of self-care.</h2>
      ...
      <section className="rates-section">
        ...
        <p>For out-of-network plans, I’ve partnered with Mentaya using <a href="#">this tool</a>.</p>
      </section>
